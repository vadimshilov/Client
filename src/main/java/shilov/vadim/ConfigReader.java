...
public class ConfigReader {
    ...
    private static String ADDRESS_PROPERTY="server.address";
    ...
    /**
     * получает аддреса сервера
     * @return адрес сервера, прочитанный из файлы; если значение не удалось получить из файла, возвращает null
     */
    public String getAddress(){
        if(properties!=null) {
            return properties.getProperty(ADDRESS_PROPERTY);
        }
        else
            return null;
    }
